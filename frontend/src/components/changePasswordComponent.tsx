...
export default class ChangePassword extends
        Component<any, ChangePasswordState> {
    ...
    onChangeValue(e: any, type: 'old_password' | 'password' | 'ensure_password') {
    ...
    handleChanging(e: React.FormEvent<HTMLFormElement>) {
        ...
        if (
            this.onChangeValue({target: {value: this.state.old_password}}, 'old_password') &&
            ...
            // changing request
            AuthService.modifyPassword(this.state.username,
                this.state.old_password, this.state.password).then(
                () => {
                    // modify success
                    // alert
                    this.setState({
                ...
                >
                    ...
                    <Box component="form"
                        ...
                        <TextField
                            ...
                            onChange={e => this.onChangeValue(e, 'old_password')}
                            // @ts-ignore
                            error={this.state.error_msg_old_password.length !== 0}
                            // @ts-ignore
